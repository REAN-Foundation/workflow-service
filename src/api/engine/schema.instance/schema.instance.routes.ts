...
export const register = (app: express.Application): void => {
    ...
    router.get('/:id/activity-history', Auth.handle(`${contextBase}.ActivityHistory`, false, false, false), controller.getActivityHistory);
    router.get('/:id/activity-summary', Auth.handle(`${contextBase}.ActivitySummary`, false, false, false), controller.getActivitySummary);
